...
void MainWindow::_setup_callbacks()
{
    ...
    m_menu_bar->set_start_record_callback([this](const std::string& fileName) { m_render_window->start_record(fileName); });
    m_menu_bar->set_stop_record_callback([this]() { m_render_window->end_record(); });
